...
var mailformat = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
			...
			if((fname.length <= 2) || (fname.length > 15)) {
				document.getElementById('error_message').innerHTML =" ** firstname lenght must be between 2 and 15";
				return false;
			}
			if(!isNaN(fname)){
      ...
      if((lname.length <= 2) || (lname.length > 15)) {
        document.getElementById('error_message').innerHTML =" ** Lastname lenght must be between 2 and 15";
        return false;
      }
      if(!isNaN(lname)){
        document.getElementById('error_message').innerHTML =" ** only characters are allowed";
        return false;
			...
			if((pass.length <= 5) || (pass.length > 10)) 
                         {
				document.getElementById('error_message').innerHTML =" ** Passwords lenght must be between  5 and 10";
				return false;
			}
			...
			if((presentadd.length <= 2) || (presentadd.length > 10)) {
				document.getElementById('error_message').innerHTML =" ** Present Address lenght must be between 2 and 10";
				return false;
			}
      ...
      if((parmanentadd.length <= 2) || (parmanentadd.length > 30)) {
        document.getElementById('error_message').innerHTML =" ** Parmanent Address lenght must be between 2 and 30";
        return false;
      }
